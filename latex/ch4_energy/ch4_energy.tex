...
\begin{subequations}
	...
	\vect{F}^{1}_{i} 	= - \frac{\vect{e}_i \times \mat{M}_i}{|\vect{e}_i|} \\
	\vect{F}^{2}_{i} 	= \frac{\vect{e}_i \times \mat{M}_{i+1}}{|\vect{e}_i|} \\ 
...
%\note{
%Valable en partie courante, mais pas aux bords. Attention au changement de propriétés mécaniques sur le segment. Il ya un couac avec M qui dépend à la fois de kb (pointwise) et de EI (edgewise).  Pas forcément pour beta.
%}
And
\begin{equation}
