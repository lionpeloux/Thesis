...
\blankpage{
	...
	\AddToShipoutPictureBG*{%
		...
		\PhotoCaptionRef[
			...
			phantom=true,
			anchor=north west,
			]{figure}{}{Centerline of the discrete biarc model}{fig:discrete_model}
		\PhotoTextBox[
			node=CAbl,
			anchor=south west,
			width=\tmpwidth,
			border=false,
				...
				\figurecaption{fig:discrete_model}\par\medskip
				The centerline is divided into curved segments (grey solid hatch). Each segment is defined as a three-noded element with uniform material and section properties. It has two end vertices (white) called \emph{handle} as they are used to interact with the model, for instance to apply loads or restrains. It has one mid vertex (grey) called \emph{ghost} as it is used only to enrich the segment kinematics and is not accessible to the end user.
			}
		\PhotoTextBox[
			node=CAbr,
			anchor=south east,
		...
		\SBox[%
			...
			yshift=\PhotoRefSkip,
				...
				\ra{1}%
				\begin{tabularx}{0.9\tmpwidth}{@{} X l r  r@{}}
					\toprule
		...
		\PhotoCaptionRef[
			...
			anchor=north west, 
			phantom=true,
			]{table}{}{Number of segments, edges and vertices whether the centerline is closed or open}{tab:count}
	}
}
...
% Discrete extension and axial force
% --------------------------------------------
...
% Discrete bending moments and curvatures
% -------------------------------------------------------
...
\blankpage{
	\hbox{}\thispagestyle{empty}
	\AddToShipoutPictureBG*{%
		\settoheight{\tmpheight}{\includegraphics[]{E1.pdf}}
		\setlength{\tmpheight}{(\textheight-5\tmpheight)/4}
		% \setlength{\tmpwidth}{(\textwidth-\PhotoBigSkip)/2}
		\Photo[
			node=CAtl,
			anchor=north west,
		...
		\PhotoCaptionRef[
			...
			yshift=\PhotoRefSkip,
			phantom=true,
			]{figure}{}{Calculation of the biarc parameters}{fig:biarcparam}
		...
		\PhotoCaptionRef[
			...
			]{subfigure}{}{Geometric curvature at ghost vertices}{fig:biarcparam_a}
		\intersectnode{CAtr |- Bbl}{Pt}
		\PhotoCaptionRef[
			hrefnode=Btl,
			node=Pt,
			anchor=south east,
			% xshift=2\PhotoBigSkip,
			]{subfigure}{}{Unit tangent vector at ghost vertices}{fig:biarcparam_b}
		\intersectnode{CAtr |- Cbl}{Pt}
		\PhotoCaptionRef[
			hrefnode=Ctl,
			node=Pt,
			anchor=south east,
			% xshift=2\PhotoBigSkip,
			]{subfigure}{}{Left/right unit tangent vector at handle vertices}{fig:biarcparam_c}
		\intersectnode{CAtr |- Dbl}{Pt}
		\PhotoCaptionRef[
			hrefnode=Dtl,
			node=Pt,
			anchor=south east,
			% xshift=2\PhotoBigSkip,
			]{subfigure}{}{Unit tangent vector at handle vertices}{fig:biarcparam_d}
		\intersectnode{CAtr |- Ebl}{Pt}
		\PhotoCaptionRef[
			hrefnode=Etl,
			node=Pt,
			anchor=south east,
			% xshift=2\PhotoBigSkip,
			]{subfigure}{}{Left/right bending moment at handle vertices}{fig:biarcparam_e}
	}
}
...
% Discrete shear force
% --------------------------
\subsection{Discrete shear force}
...
\afterpage{%
	\AddToShipoutPictureBG*{% 
		...
		\PhotoCaptionRef[
			...
			anchor=north west,
			phantom=true,
			]{figure}{}{Parabolic interpolation of the kinetic energy peak}{fig:ek_interp}
		...
		\PhotoTextBox[
			...
			border=false,
				...
				\figurecaption{fig:ek_interp}\par\medskip
			}
	}
	\setlength{\tmpheight}{9cm}
...
\doubleblankpage[l]{%
	...
	\AddToShipoutPictureBG*{% 
		...
		\Photo[
			...
			yshift=-0.5cm,
			gopt={scale=0.8},
			]{ch7_numeric/plot/1_pendulum/build_Ep.pdf}%
		\savenodes{B}
		\PhotoCaptionRef[
			node=Atl, 
			anchor=north west, 
			% yshift=-\PhotoRefSkip,
			phantom=true,
			]{figure}{}{Application of the DR process to the simple plane pendulum}{fig:planependulum}
		\intersectnode{CAtr |- Abr}{Pt}
		\PhotoCaptionRef[
			hrefnode=Atl,
			node=CAtr,
			anchor=north east, 
			]{subfigure}{}{First steps until the first peak of $\mathcal{E}_k$ is reached}{fig:pendulum}
		\intersectnode{CAtr |- Btr}{Pt}
		\PhotoCaptionRef[
			hrefnode=Btl,
			node=Pt,
			anchor=north east, 
			]{subfigure}{}{Potential energy of the pendulum for the first steps}{fig:pendulum_Ep}
		\PhotoTextBox[
			node=CAbl,
			anchor=south west,
			xshift=-\tmpwidth,
			...
			border=false,
				...
				\figurecaption{fig:planependulum}\par\medskip
				\figurecaption{fig:pendulum}\par
				\figurecaption{fig:pendulum_Ep}
			}
	}
}{
	\hbox{}\thispagestyle{empty}
	\AddToShipoutPictureBG*{% 
		\Photo[
			...
			yshift=0.5cm,
			gopt={scale=0.8},
			]{ch7_numeric/plot/1_pendulum/build_Ek.pdf}%
		\savenodes{A}
		\Photo[
			node=CAb,
			anchor=south,
			...
			yshift=-0.5cm,
			gopt={scale=0.8},
			]{ch7_numeric/plot/1_pendulum/build_Phase.pdf}%
		\savenodes{B}
		\PhotoCaptionRef[
			node=Atl, 
			anchor=north west, 
			% yshift=-\PhotoRefSkip,
			phantom=true,
			]{figure}{}{Convergence of the DR process for the simple plane pendulum}{fig:drsteps}
		\intersectnode{CAtl |- Abr}{Pt}
		\PhotoCaptionRef[
			hrefnode=Atl,
			node=CAtl,
			anchor=north west, 
			]{subfigure}{}{Typical profile of the kinetic damping}{fig:pendulum_Ek}
		\intersectnode{CAtl |- Btr}{Pt}
		\PhotoCaptionRef[
			hrefnode=Btl,
			node=Pt,
			anchor=north west, 
			]{subfigure}{}{Convergence of the DR process in the phase space}{fig:pendulum_Phase}
		\PhotoTextBox[
			node=CAbr,
			anchor=south east,
			xshift=\tmpwidth,
			...
			border=false,
				...
				\figurecaption{fig:drsteps}\par\medskip
				\figurecaption{fig:pendulum_Ek}\par
				\figurecaption{fig:pendulum_Phase}
			}
	}
}
...
\afterpage{%
	\AddToShipoutPictureBG*{% 
		...
		\PhotoCaptionRef[
			...
			anchor=north west,
			phantom=true,
			]{figure}{}{Partial class diagram of \textit{Marsupilami.Math.dll}}{fig:mathlib}
		\intersectnode{CAtl |- Abr}{Pt}
		\PhotoTextBox[
			node=Pt,
			anchor=north west,
			...
			border=false,
				...
				\figurecaption{fig:mathlib}
			}
	}
	\setlength{\tmpheight}{13cm}
	\hbox{\vspace{\tmpheight}}
}
	...
	\AddToShipoutPictureBG*{%
		...
		\SBox[%
			...
			anchor=south,
				...
				\ra{1.0}%
				\begin{tabularx}{0.5\textwidth}{@{} X ccccc @{}}
					\toprule
		...
		\PhotoCaptionRef[
			...
			anchor=north west, 
			phantom=true,
			]{table}{}{Simple cost model for arithmetic operations}{tab:costmodel}		
	}
}
...
\afterpage{%
	\AddToShipoutPictureBG*{% 
		...
		\PhotoCaptionRef[
			...
			anchor=north west,
			phantom=true,
			]{figure}{}{Test case of a constrained arch}{fig:bench_arch}
		\PhotoTextBox[
			node=CAtl,
			anchor=north west,
			yshift=-13cm,
			...
			border=false,
				...
				\figurecaption{fig:bench_arch}
			}
	}
	\setlength{\tmpheight}{13.5cm}
	\hbox{\vspace{\tmpheight}}
	\afterpage{%
		\AddToShipoutPictureBG*{% 
			\Photo[
			...
			\PhotoCaptionRef[
				...
				anchor=north west,
				phantom=true,
				]{figure}{}{Comparison of normalized force diagrams}{fig:bench_arch_diagram}
			\PhotoTextBox[
				node=CAtl,
				anchor=north west,
				yshift=-13cm,
				...
				border=false,
					...
					\figurecaption{fig:bench_arch_diagram}
				}
			\PhotoTextBox[
				node=Abr,
				anchor=north east,
				...
				border=false,
					...
					\scriptsize\raggedleft Marsupilami~: blue | Abaqus : black
				}
		}
		\setlength{\tmpheight}{13.5cm}
		\hbox{\vspace{\tmpheight}}
...
% 	\captionof{figure}[Comparison of normalized force diagrams]{Comparison of normalized force diagrams for the finest discretization ($n_{el}=96$ | Marsupilami~: blue | Abaqus : grey).}
...
\blankpage{
	...
	\AddToShipoutPictureBG*{%
		...
		\PhotoCaptionRef[
			...
			% yshift=-\PhotoRefSkip,
			phantom=true,
			]{table}{}{Internal forces for the arch test case}{tab:resA_force}
		\PhotoTextBox[
			node=Abl,
			anchor=south east,
			xshift=-2cm,
...
\blankpage{
	...
	\AddToShipoutPictureBG*{%
		...
		\PhotoCaptionRef[
			...
			% yshift=-\PhotoRefSkip,
			phantom=true,
			]{table}{}{Internal moments for the arch test case}{tab:resA_moment}
		\PhotoTextBox[
			node=Abr,
			anchor=south west,
			xshift=2cm,
...
\blankpage{
	...
	\AddToShipoutPictureBG*{%
		...
		\PhotoCaptionRef[
			...
			% yshift=-\PhotoRefSkip,
			phantom=true,
			]{table}{}{Geometric parameters for the arch test case}{tab:resA_geo}
		\PhotoTextBox[
			node=CAbl,
			anchor=south west,
			% yshift=-\PhotoRefSkip,
