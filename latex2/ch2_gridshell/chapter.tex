...
\blankpage{%
	...
	\AddToShipoutPictureBG*{% 
		...
		\PhotoCaptionRef[
			...
			yshift=-\PhotoSkip,
			phantom=true,
			]{figure}{}{Forming process of the gridshell of Mannheim, Germany}{fig:erec}
		\PhotoCaptionRef[
			hrefnode=Atl,
			node=Atl, 
			anchor=south west, 
			yshift=\PhotoRefSkip,
			]{subfigure}{}{Assembly of the timber grid}{fig:gserec_0}
		\PhotoCaptionRef[
			hrefnode=Btl,
			node=Btl, 
			anchor=south west, 
			yshift=\PhotoRefSkip,
			]{subfigure}{}{Deformation of the grid}{fig:gserec_1}
		\PhotoCaptionRef[
			hrefnode=Ctl,
			node=Cbl, 
			anchor=north west, 
			yshift=-\PhotoRefSkip,
			]{subfigure}{}{Final shape of the lattice}{fig:gserec_2}
		\PhotoCaptionRef[
			hrefnode=Dtl,
			node=Dbl, 
			anchor=north west, 
			yshift=-\PhotoRefSkip,
			]{subfigure}{}{Roofing with a membrane}{fig:gserec_3}
		\PhotoTextBox[
			node=CAbl,
			anchor=base west,
			width=10cm,
			border=false,
				...
				\figurecaption{fig:erec}\par
				\figurecaption{fig:gserec_0}\par
				\figurecaption{fig:gserec_1}\par
				\figurecaption{fig:gserec_2}\par
				\figurecaption{fig:gserec_3}\par
			}
	}
}
...
% ------------------------------------------
Usually, the grid morphology is not trivial and leads to design numerous costly and complex joints. To overcome this issue, an original and innovative erection process was developed that takes advantage of the flexibility inherent to slender elements. A regular planar grid made of long continuous linear members is built on the ground (see \cref{fig:gserec_0}). The elements are pinned together so the grid has no in-plane shear stiffness and can accommodate large-scale deformations during erection. Then, the grid is bent elastically to its final shape (see \cref{fig:gserec_1,fig:gserec_2}). Finally, the grid is frozen in the desired shape with a third layer of bracing members and the structure becomes a shell. This process is illustrated and detailed in the next chapter (see \cref{sec=construction_process}).
...
\blankpage{%
	...
	\PhotoCaptionRef[
		...
		yshift=-\PhotoRefSkip,
		phantom=true,
		]{figure}{}{Known elastic gridshells built by the past}{fig:projectsbymaterial}
	\PhotoTextBox[
		node=CAbl,
		anchor=base west,
		width=10cm,
		border=false,
			...
			\figurecaption{fig:projectsbymaterial}\par\smallskip
			The surface of the bubbles is proportional to the covered area. Colour indicates the material employed for the rods.
		}
	}\hbox{}
}
...
\doubleblankpage[r]{
	...
	\AddToShipoutPictureBG*{%
		...
		\Photo[
			node=CAbl,
			anchor=south west,
			gopt={trim=0 0 0 0.5cm, clip, width=\tmpwidth},
			]{essen_foil_full.jpg}
		\savenodes{C}
		\PhotoCaptionRef[
			hrefnode=Atl,
			...
			anchor=north west,
			phantom=true,
		]{figure}{}{Steel gridshell built in 1962 in Berkeley, USA}{fig:berkeley}
		\PhotoCaptionRef[
			hrefnode=Atl,
			node=Abr, 
			anchor=base west,
			xshift=\PhotoRefSkip,
		]{subfigure}{}{Steel lattice}{fig:berkeley_a}
		\PhotoCaptionRef[
			hrefnode=Btl,
			node=Bbr, 
			anchor=base west,
			xshift=\PhotoRefSkip,
		]{subfigure}{}{Knot detail}{fig:berkeley_b}
		\intersectnode{Cbl -| Atl}{Pt}
		\PhotoCaptionRef[
			hrefnode=Ctl,
			node=Pt, 
			anchor=north west,
			yshift=-\PhotoRefSkip,
		]{figure}{}{Timber gridshell built in 1962 in Essen, Germany}{fig:essen}
	}\hbox{}
}{
	\thispagestyle{pageonly}
	\AddToShipoutPictureBG*{%
		...
		\PhotoCaptionRef[
			...
			anchor=north east,
			yshift=-\PhotoRefSkip,
		]{figure}{}{Timber gridshell built in 1967 in Montreal, Canada}{fig:montreal}
		\PhotoTextBox[
			node=CAbl,
			anchor=base west,
			width=\textwidth/2,
			]{%
				\figurecaption{fig:berkeley}\par
				\figurecaption{fig:berkeley_a}\par
				\figurecaption{fig:berkeley_b}\par\medskip
				\figurecaption{fig:essen}\par
				\figurecaption{fig:montreal}
			}
	}
	\hbox{}
}
...
\afterpage{%
	...
	\AddToShipoutPictureBG*{
		...
		\savenodes{A}
		\intersectnode{CAtl |- Abl}{Pt}
		\PhotoCaptionRef[
			hrefnode=Atl,
			node=Atl, 
			anchor=north west, 
			phantom=true,
		]{figure}{}{Timber gridshell built in 1975 in Mannheim, Germany}{fig:mannheim}
		\PhotoCaptionRef[
			hrefnode=Atl,
			node=Pt, 
			anchor=north west, 
			yshift=-\PhotoRefSkip,
		]{subfigure}{}{Sky view}{fig:mannheim_b}
		\global\PhotoHeight=\PhotoHeight
	}
	\settoheight{\PhotoHeight}{\includegraphics[width=\textwidth]{mannheim_sky.jpg}}
	\addtolength{\PhotoHeight}{\PhotoBigSkip}
	\hbox{\vspace{\PhotoHeight}}
	%
	\doubleblankpage[l]{%
		...
		\AddToShipoutPictureBG*{
			\PhotoCaptionRef[
				...
				anchor=north west,
				yshift=-\PhotoRefSkip,
			]{subfigure}{}{Interior view}{fig:mannheim_a}}
	}{%
		\hbox{}\thispagestyle{empty}
		\AddToShipoutPictureBG*{
			\PhotoTextBox[
				...
				\figurecaption{fig:mannheim}\par
				\figurecaption{fig:mannheim_b}\par
				\figurecaption{fig:mannheim_a}
			}}
	}
}
...
\blankpage{%
	...
	\AddToShipoutPictureBG*{% 
		...
		\PhotoCaptionRef[
			...
			yshift=-\PhotoSkip,
			phantom=true,
			]{figure}{}{Roundwood gridshell built in 1995 in Dorset, England}{fig:dorset}
		\PhotoCaptionRef[
			hrefnode=Atl,
			node=Atl, 
			anchor=south west, 
			yshift=\PhotoRefSkip,
			]{subfigure}{}{Interior view}{fig:dorset_a}
		\PhotoCaptionRef[
			hrefnode=Btl,
			node=Btl, 
			anchor=south west, 
			yshift=\PhotoRefSkip,
			]{subfigure}{}{Exterior view}{fig:dorset_b}
		%%
		\PhotoCaptionRef[
			hrefnode=Ctl,
			node=Ctl,
			...
			yshift=-\PhotoSkip,
			phantom=true,
			]{figure}{}{Timber gridshells built in 1998 in Doncaster, England}{fig:doncaster}
		\PhotoCaptionRef[
			hrefnode=Ctl,
			node=Cbl, 
			anchor=north west, 
			yshift=-\PhotoRefSkip,
			]{subfigure}{}{Interior view}{fig:doncaster_a}
		\PhotoCaptionRef[
			hrefnode=Dtl,
			node=Dbl, 
			anchor=north west, 
			yshift=-\PhotoRefSkip,
			]{subfigure}{}{Exterior view}{fig:doncaster_b}
		\PhotoTextBox[
			node=CAbl,
			anchor=base west,
			width=10cm,
			border=false,
				...
				\figurecaption{fig:dorset}\par
				\figurecaption{fig:dorset_a}\par
				\figurecaption{fig:dorset_b}\par\medskip
				\figurecaption{fig:doncaster}\par
				\figurecaption{fig:doncaster_a}\par
				\figurecaption{fig:doncaster_b}\par
			}
	}
}
...
\afterpage{%
	...
	\AddToShipoutPictureBG*{
		...
		\Photo[
			...
			anchor=north west,
			yshift=-\PhotoBigSkip,
			gopt={width=\textwidth/3},
			]{hannover_int.jpg}
		\savenodes{B}
		% \intersectnode{CAtl |- Btr}{Pt}
		\Photo[
			node=Btr,
			anchor=north west,
			xshift=\PhotoSkip,
			gopt={height=0.8\PhotoHeight},
			]{hannover_detail.jpg}
		\savenodes{C}
		%%
		\PhotoCaptionRef[
			...
			anchor=north west, 
			phantom=true,
		]{figure}{}{Cardboard gridshell built in 2000 in Hannover, Germany}{fig:hannover}
		\PhotoCaptionRef[
			hrefnode=Atl,
			node=Abr, 
			anchor=north east, 
			yshift=-\PhotoRefSkip,
		]{subfigure}{}{Sky view}{fig:hannover_a}
		\PhotoCaptionRef[
			hrefnode=Atl,
			node=Btr, 
			anchor=south east, 
			yshift=\PhotoRefSkip,
		]{subfigure}{}{Interior view}{fig:hannover_b}
		\PhotoCaptionRef[
			hrefnode=Ctl,
			node=Ctr, 
			anchor=north west, 
			xshift=\PhotoRefSkip,
		]{subfigure}{}{Knot detail}{fig:hannover_c}
		\intersectnode{CAtl |- Bbr}{Pt}
		\PhotoTextBox[
			node=Bbr,
			anchor=base west,
			xshift=\PhotoSkip,
			...
			border=false,
				...
				\figurecaption{fig:hannover}\par
				\figurecaption{fig:hannover_b}\par
				\figurecaption{fig:hannover_a}\par
				\figurecaption{fig:hannover_c}\par
			}
	}
	\newlength\ha
	\newlength\hb
	\newlength\myh
	\newlength\myw
	\settoheight{\ha}{\includegraphics[width=\textwidth]{hannover_sky.jpg}}
	\settoheight{\hb}{\includegraphics[width=\textwidth/3]{hannover_int.jpg}}
	\setlength{\myh}{2\PhotoBigSkip+\ha+\hb}
	\hbox{\vspace{\myh}}
}
...
{\afterpage{%	
	...
	\settoheight{\myh}{\includegraphics[height=5cm]{downland_e1.jpg}}
	\settowidth{\myw}{\includegraphics[height=5cm]{downland_e1.jpg}}
	\gdef\mycode{\intersectnode{CAtr |- CAbl}{PSA}}
	\intersectnode{CAtr |- CAbl}{PSA}
	\PhotoSpread[
		lpcode=\mycode,
		node=PSA,
		anchor=south west,
		xshift={-\PaperWidth+2\myw+2\PhotoSkip+3cm},
		gopt={height=5cm},
		]{downland_e3.jpg}
	\savenodes{C}
	\AddToShipoutPictureBG*{
		...
		\PhotoCaptionRef[
			...
			anchor=south west,
			phantom=true,
			]{figure}{}{Construction stages of the Downland gridshell}{fig:downland_e}
		\PhotoCaptionRef[
			hrefnode=Atl,
			node=Abr, 
			anchor=north east, 
			yshift=-\PhotoRefSkip,
			]{subfigure}{}{Flat grid on scaffold platform}{fig:downland_e1}
		\PhotoCaptionRef[
			hrefnode=Btl,
			node=Bbr, 
			anchor=north east, 
			yshift=-\PhotoRefSkip,
			]{subfigure}{}{Deformed grid}{fig:downland_e2}
	}
	}{%
	\hbox{}\thispagestyle{empty}
	\AddToShipoutPictureBG*{
		\PhotoCaptionRef[
			...
			anchor=north east, 
			yshift=-\PhotoRefSkip,
			]{subfigure}{}{Triangulated grid}{fig:downland_e3}
		\Photo[
			node=BR,
			anchor=south west,
			xshift=\PhotoSkip,
		...
		\PhotoCaptionRef[
			...
			anchor=north east, 
			yshift=-\PhotoRefSkip,
			]{subfigure}{}{Final structure with cladding}{fig:downland_e4}
		\PhotoTextBox[
			node=CAtl,
			anchor=north west,
			width=10cm,
			...
			\figurecaption{fig:downland_e}\par		
			\figurecaption{fig:downland_e1}\par
			\figurecaption{fig:downland_e2}\par
			\figurecaption{fig:downland_e3}\par
			\figurecaption{fig:downland_e4}
		}}
	}
}}
...
\blankpage{%
	...
	\AddToShipoutPictureBG*{% 
		% \GetLayoutNodes
		\def\tmpwidth{(\textwidth-\PhotoSkip)/2}
		% required to avoid mess up between tikz overlay and page vertical blank space
		\Photo[
			node=CAtl,
			anchor=north west,
		...
		\Photo[
			...
			xshift=0mm,
			yshift=-\PhotoBigSkip,
			gopt={trim=0 1.75cm 0 0, clip, width=\textwidth},
			]{downland_a.jpg}%
		\savenodes{B}
		\PhotoCaptionRef[
			node=Atl,
			...
			yshift=-\PhotoSkip,
			phantom=true,
			]{figure}{}{Timber gridshell built in 2002 in Downland, England}{fig:downland}
		\PhotoCaptionRef[
			hrefnode=Atl,
			node=Atl, 
			anchor=south west, 
			yshift=\PhotoRefSkip,
			]{subfigure}{}{Interior view}{fig:downland_a}
		\PhotoCaptionRef[
			hrefnode=Btl,
			node=Btl, 
			anchor=south west, 
			yshift=\PhotoRefSkip,
			]{subfigure}{}{Exterior view}{fig:downland_b}
		\PhotoTextBox[
			node=CAbl,
			anchor=base west,
			width=10cm,
			border=false,
				...
				\figurecaption{fig:downland}\par
				\figurecaption{fig:downland_a}\par
				\figurecaption{fig:downland_b}
			}
	}
}
...
The flat lattice was laid out on a scaffold platform (see \cref{fig:downland_e1}). Unlike the Japan Pavilion, the lattice was progressively lowered down into position (see \cref{fig:downland_e2}). This stage took 6 weeks. Once deformed, the shear blocks were introduced in the grid and bracing rib-laths were installed, giving its full strength to the shell (see \cref{fig:downland_e3}). Finally the gridshell was cladded with a mix of polycarbonate plates (to let the light in) and timber boards on top of insulation panels and a rain screen (see \cref{fig:downland_e4}).
...
\blankpage{%
	...
	\AddToShipoutPictureBG*{% 
		...
		\PhotoCaptionRef[
			...
			yshift=-\PhotoSkip,
			phantom=true,
			]{figure}{}{Timber gridshell built in 2002 in Pishwanton, England}{fig:pishwanton}
		\PhotoCaptionRef[
			hrefnode=Atl,
			node=Atl, 
			anchor=south west, 
			yshift=\PhotoRefSkip,
			]{subfigure}{}{Interior view}{fig:pishwanton_a}
		\PhotoCaptionRef[
			hrefnode=Btl,
			node=Btl, 
			anchor=south west, 
			yshift=\PhotoRefSkip,
			]{subfigure}{}{Exterior view}{fig:pishwanton_b}
		%%
		\PhotoCaptionRef[
			hrefnode=Ctl,
			node=Ctl,
			...
			yshift=-\PhotoSkip,
			phantom=true,
			]{figure}{}{Timber gridshells built in 1998 in Doncaster, England}{fig:flimwell}
		\PhotoCaptionRef[
			hrefnode=Ctl,
			node=Cbl, 
			anchor=north west, 
			yshift=-\PhotoRefSkip,
			]{subfigure}{}{Interior view}{fig:flimwell_a}
		\PhotoCaptionRef[
			hrefnode=Dtl,
			node=Dbl, 
			anchor=north west, 
			yshift=-\PhotoRefSkip,
			]{subfigure}{}{Exterior view}{fig:flimwell_b}
		\PhotoTextBox[
			node=CAbl,
			anchor=base west,
			width=10cm,
			border=false,
				...
				\figurecaption{fig:pishwanton}\par
				\figurecaption{fig:pishwanton_a}\par
				\figurecaption{fig:pishwanton_b}\par\medskip
				\figurecaption{fig:flimwell}\par
				\figurecaption{fig:flimwell_a}\par
				\figurecaption{fig:flimwell_b}\par
			}
	}
}
...
\blankpage{%
	...
	\AddToShipoutPictureBG*{% 
		...
		\PhotoCaptionRef[
			...
			yshift=-\PhotoSkip,
			phantom=true,
			]{figure}{}{Timber gridshell built in 2006 in Savill, England}{fig:savill}
		\PhotoCaptionRef[
			hrefnode=Atl,
			node=Atr, 
			anchor=south east, 
			yshift=\PhotoRefSkip,
			]{subfigure}{}{Interior view}{fig:savill_a}
		\PhotoCaptionRef[
			hrefnode=Btl,
			node=Btr, 
			anchor=south east, 
			yshift=\PhotoRefSkip,
			]{subfigure}{}{Exterior view}{fig:savill_b}
		%%
		\PhotoCaptionRef[
			hrefnode=Ctl,
			node=Ctl,
			...
			yshift=-\PhotoSkip,
			phantom=true,
			]{figure}{}{Timber gridshell built in 2007 in Kent, England.}{fig:kent}
		\PhotoCaptionRef[
			hrefnode=Ctl,
			node=Cbr, 
			anchor=north east, 
			yshift=-\PhotoRefSkip,
			]{subfigure}{}{Glazing support}{fig:kent_a}
		\PhotoCaptionRef[
			hrefnode=Dtl,
			node=Dbr, 
			anchor=north east, 
			yshift=-\PhotoRefSkip,
			]{subfigure}{}{Exterior view}{fig:kent_b}
		\PhotoTextBox[
			node=CAbl,
			anchor=base west,
			width=10cm,
			border=false,
				...
				\figurecaption{fig:savill}\par
				\figurecaption{fig:savill_a}\par
				\figurecaption{fig:savill_b}\par\medskip
				\figurecaption{fig:kent}\par
				\figurecaption{fig:kent_a}\par
				\figurecaption{fig:kent_b}\par
			}
	}
}
...
\afterpage{%
	...
	\AddToShipoutPictureBG*{
		...
		\PhotoCaptionRef[
			...
			anchor=north west, 
			phantom=true,
		]{figure}{}{GFRP gridshells built in 2006 and 2007 in Noisy-Champs, France}{fig:proto}
		\PhotoCaptionRef[
			hrefnode=Atl,
			node=Abl, 
			anchor=north west, 
			yshift=-\PhotoRefSkip,
		]{subfigure}{}{First prototype 2006}{fig:proto_a}
		\PhotoCaptionRef[
			hrefnode=Btl,
			node=Bbl, 
			anchor=north west, 
			yshift=-\PhotoRefSkip,
		]{subfigure}{}{Second prototype 2007}{fig:proto_b}
		\PhotoTextBox[
			node=Abl,
			anchor=north west,
			...
			border=false,
				...
				\figurecaption{fig:proto}\par
				\figurecaption{fig:proto_a}\par
				\figurecaption{fig:proto_b}
			}
	}
	\settoheight{\ha}{\includegraphics[width=(\textwidth-\PhotoSkip)/2]{proto_b.jpg}}
	\setlength{\myh}{3\PhotoBigSkip+\PhotoSkip+\ha}
	\hbox{\vspace{\myh}}
}

\subsubsection{The first gridshells in composte material, Champs-sur-Marne, France, 2006}
\label{sec=proto}
These developments have been validated by the construction of two prototypes in 2006 (see \cref{fig:proto_a}) and in 2007 (see \cref{fig:proto_b}) \cite{Douthe2006}. These structures were left outside for about 7 years. They covered about \SI{150}{m^2} each, spanning around 13 meters. The structures were single-layer gridshells made with pultruded GFRP tubes (\O \SI{41.7}{mm} x \SI{3.5}{mm}) assembled with a standard scaffold swivel connector. The grid was braced with a third layer of tubes and covered with a PVC coated fabric membrane providing full waterproofness.
...
\doubleblankpage[l]{%
	...
	\AddToShipoutPictureBG*{% 
		...
		\PhotoCaptionRef[
			...
			anchor=south east,
			yshift=\PhotoRefSkip,
			]{figure}{}{Solidays GFRP gridshell built in 2011 in Paris, France}{fig:solidays}
		\PhotoTextBox[
			node=Pt,
			anchor=north west,
			yshift=-\PhotoSkip,
	...
	\hbox{}
	\AddToShipoutPictureBG*{% 
		\def\tmpwidth{\textwidth+\ContentInnerMargin+\ContentBindingOffset+\BleedInnerMargin}
		\settoheight{\ha}{\includegraphics[width=\tmpwidth]{creteil_int_a.jpg}}
		\def\tmpheight{\textheight-\ha-\PhotoBigSkip}
		% required to avoid mess up between tikz overlay and page vertical blank space
		\intersectnode{PPtl |- CAtr}{Pt}
		\Photo[
			node=Pt,
			anchor=north west,
			xshift=0mm,
		...
		\PhotoCaptionRef[
			...
			anchor=north west,
			phantom=true,
			]{figure}{}{GFRP gridshell built in 2013 in Créteil, France}{fig:creteil}
		\PhotoCaptionRef[
			hrefnode=Atl,
			node=Atr,
			anchor=south east,
			yshift=\PhotoRefSkip,
			]{subfigure}{}{Interior view}{fig:creteil_a}
		\PhotoCaptionRef[
			hrefnode=Btl,
			node=Bbl,
			anchor=north west,
			yshift=-\PhotoRefSkip,
			]{subfigure}{}{Exterior view}{fig:creteil_b}
		\PhotoTextBox[
			node=Bbr,
			anchor=base west,
			xshift=\PhotoSkip,
			...
			border=false,
				...
				\figurecaption{fig:creteil}\par\smallskip
				\figurecaption{fig:creteil_a}\par
				\figurecaption{fig:creteil_b}
			}
	}
}
...
In 2011, \href{http://navier.enpc.fr}{Navier} (L. du Peloux, O. Baverel, J-F. Caron, F. Tayeb) used its knowledge to design with a team of students a temporary pavilion for a music festival in Paris, France (see \cref{fig:solidays}).\footnote{Photos and videos of the construction process at: \url{http://thinkshell.fr/gridshell-solidays-2011/}} Although the constructive system was similar to the one employed for the two prototypes, the size and the span were more than twice larger \cite{Baverel2012}. In addition, it was the first gridshell in composite material that hosted some public and therefore had to comply with strict building regulations.

To our knowledge, it is also the first gridshell that was designed using the compass method \cite{IL10}, thus providing an inverse method to design the structure directly from the shape given by the architect. The single-layer gridshell covered about \SI{280}{m^2} and was erected by two mobile cranes.
...
\blankpage{%
	...
	\AddToShipoutPictureBG*{% 
		...
		\PhotoCaptionRef[
			...
			yshift=-\PhotoSkip,
			phantom=true,
			]{figure}{}{Timber gridshells built by gridshell.it in Italy}{fig:gsit}
		\PhotoCaptionRef[
			hrefnode=Atl,
			node=Atl, 
			anchor=south west, 
			yshift=\PhotoRefSkip,
			]{subfigure}{}{Lecce 2010}{fig:lecce}
		\PhotoCaptionRef[
			hrefnode=Btl,
			node=Btl, 
			anchor=south west, 
			yshift=\PhotoRefSkip,
			]{subfigure}{}{Toledo 2014}{fig:toledo2}
		%%
		\PhotoCaptionRef[
			hrefnode=Ctl,
			node=Ctl,
			...
			yshift=-\PhotoSkip,
			phantom=true,
			]{figure}{}{Timber gridshell built in 2013 in San Antonio, USA}{fig:sanantonio}
		\PhotoCaptionRef[
			hrefnode=Ctl,
			node=Cbl,
			anchor=north west, 
			yshift=-\PhotoRefSkip,
			]{subfigure}{}{Folding skin}{fig:sanantonio2}
		\PhotoCaptionRef[
			hrefnode=Dtl,
			node=Dbl, 
			anchor=north west, 
			yshift=-\PhotoRefSkip,
			]{subfigure}{}{Pavilion}{fig:sanantonio1}
		\PhotoTextBox[
			node=CAbl,
			anchor=base west,
			width=10cm,
			border=false,
				...
				\figurecaption{fig:gsit}\par
				\figurecaption{fig:lecce}\par
				\figurecaption{fig:toledo2}\par\medskip
				\figurecaption{fig:sanantonio}\par
				\figurecaption{fig:sanantonio2}\par
				\figurecaption{fig:sanantonio1}\par
			}
	}
}
...
\doubleblankpage[r]{%
	...
	\AddToShipoutPictureBG*{% 
		\def\tmpwidth{\textwidth+\ContentInnerMargin+\ContentBindingOffset+\BleedInnerMargin}
		\settoheight{\ha}{\includegraphics[width=\tmpwidth]{montpellier.jpg}}
		\def\tmpheight{\textheight-\ha-\PhotoBigSkip}
		% required to avoid mess up between tikz overlay and page vertical blank space
		\intersectnode{PPtl |- CAtr}{Pt}
		\Photo[
		...
		\PhotoCaptionRef[
			...
			anchor=north west,
			phantom=true,
			]{figure}{}{Timber gridshell built in 2016 in Montpellier, France}{fig:jpofav}
		\PhotoCaptionRef[
			hrefnode=Atl,
			node=Atr,
			anchor=south east,
			yshift=\PhotoRefSkip,
			]{subfigure}{}{Pavilion}{fig:montpellier}
		\PhotoCaptionRef[
			hrefnode=Btl,
			node=Bbl,
			anchor=north west,
			yshift=-\PhotoRefSkip,
			]{subfigure}{}{Tensioner}{fig:tensioner}
		\PhotoTextBox[
			node=Bbr,
			anchor=base west,
			xshift=\PhotoSkip,
			...
			border=false,
				...
				\figurecaption{fig:jpofav}\par
				\figurecaption{fig:montpellier}\par
				\figurecaption{fig:tensioner}
			}
	}
}{%
	\thispagestyle{pageonly}
	...
	\AddToShipoutPictureBG*{% 
		...
		\PhotoCaptionRef[
			...
			yshift=-\PhotoSkip,
			phantom=true,
			]{figure}{}{Timber gridshell built in 2016 in Champs-sur-Marne, France}{fig:clc2016}
		\PhotoCaptionRef[
			hrefnode=Atl,
			node=Atr, 
			anchor=south east, 
			yshift=\PhotoRefSkip,
			]{subfigure}{}{Robotic manufacturing}{fig:clc}
		\PhotoCaptionRef[
			hrefnode=Btl,
			node=Btr, 
			anchor=south east, 
		...
		\PhotoCaptionRef[
			...
			yshift=-\PhotoSkip,
			phantom=true,
			]{figure}{}{Hybrid structural skin built in 2016 in Champs-sur-Marne, France}{fig:booby}
		\PhotoCaptionRef[
			hrefnode=Ctl,
			node=Cbr, 
			anchor=north east, 
			yshift=-\PhotoRefSkip,
			]{subfigure}{}{Interior view}{fig:booby1}
		\PhotoCaptionRef[
			hrefnode=Dtl,
			node=Dbr, 
			anchor=north east, 
			yshift=-\PhotoRefSkip,
			]{subfigure}{}{Concrete shell}{fig:booby2}
		\PhotoTextBox[
			node=CAbl,
			anchor=base west,
			width=10cm,
			border=false,
				...
				\figurecaption{fig:clc2016}\par
				\figurecaption{fig:clc}\par
				\figurecaption{fig:clc2}\par\medskip
				\figurecaption{fig:booby}\par
				\figurecaption{fig:booby1}\par
				\figurecaption{fig:booby2}\par
			}
	}
}
...
The second experiment is a hybrid structure (see \cref{fig:booby}). It is part of our reflexion at \href{http://navier.enpc.fr}{Navier} on how to brace and clad gridshells. Indeed, the bracing of the grid in its final form remains a time consuming step with a lot of manual work. The lack of alternatives to membrane covering is also an important limitation to the development of such technology. The proposed experiment tries to tackle both issues through a novel concept of a hybrid structural skin made of an elastic gridshell (see \cref{fig:booby1}), braced with a concrete envelope (see \cref{fig:booby2}). The idea is to use the gridshell as a formwork for the concrete and to guarantee a mechanical connection between the thin concrete skin and the main grid, so that the concrete ensures the bracing of the grid and that the thickness of the concrete is reduced to a minimum. To demonstrate the feasibility and interest of this structural concept, a \SI{10}{m^2} prototype was built at the Ecole des Ponts ParisTech, France. The main aspects of the design and of the realisation of the prototype are presented by \citef{Cuvilliers2017}
