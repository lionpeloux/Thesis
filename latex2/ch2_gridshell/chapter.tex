	...
	\Photo[
		...
		boxtext={
			\parbox[t]{\textwidth}{%
				...
				\captionof{figure}[Known elastic gridshells built by the past.]{Known elastic gridshells built by the past. The surface of the bubbles is proportional to the covered area. Colour indicates the material employed for the rods.}
...
\def\code{%
	...
	\PhotoCaptionRef[node=BR,anchor=south west,label=fig:b]{the timber roof}
	\Photo[
		node=TL, 
		anchor=south west,
		yshift=5mm, 
		...
		boxanchor=south west,
		boxtext={}]{savill_b.jpg}
	\PhotoCaptionRef[node=BR, anchor=south west,label=fig:c]{the timber roof}
}
