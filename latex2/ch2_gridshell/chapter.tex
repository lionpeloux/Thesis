...
\AddToShipoutPictureBG*{% 
	...
	\PhotoCaption[
		node=Cbr,
		anchor=south west,
		yshift=\BleedBottomMargin+\ContentBottomMargin,
		xshift=\PhotoBigSkip,
		style=PS,
...
\blankpage{%
	...
	\PhotoCaption[
		...
		anchor=south west,
		yshift=\BleedBottomMargin+\SafeContentBottomMargin,
		xshift=\BleedInnerMargin+\SafeContentInnerMargin,
		width=10cm,
		style=PS,
		ltitle={Known elastic gridshells built by the past},
		subtitle={Figure~\thefigure},
		title=\capitalisewords{Elastic gridshells built by the past},
...
\blankpage{%
	\Photo[
		...
		anchor=north east,
		yshift=-\BleedTopMargin-\PhotoBigSkip,
		gopt={width=\paperwidth-\BleedInnerMargin-2\PhotoBigSkip},
		]{montreal_int.jpg}
	\savenodes{B}
	\PhotoCaptionRef[
		node=Bbr, 
