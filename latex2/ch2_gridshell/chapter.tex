	...
	\AddToShipoutPictureBG*{%
		...
		\PhotoTextBox[
			...
			width=\textwidth/2,
				...
				\figurecaption{fig:montreal}\par
				\figurecaption{fig:essen}
			}
	}
	\hbox{}
}
...
\begin{figure}[t]
	...
	\begin{subfigure}[b]{\TwoMediaWidth}
		...
		\label{fb}
	\end{subfigure}
	\captionof{figure}[Hybrid structural skin]{Hybrid structural skin built in 2016 in Champs-sur-Marne, France.}
	\label{f}
\end{figure}
...
\ztitlerefsetup{title=pouet}
\ztitleref{fa}\\
\ztitleref{fb}\\
\ztitleref{f}\\
\zdescref{f}\\
\ztitleref{sec=review_research}\\
