...
\begin{figure}[t]
		\subfloat[][Almost flat grid]{\includegraphics[width=0.48\textwidth]{mannheim_erection_1.jpg}\label{fig:erec_1}}
		\hspace*{\fill}
		\subfloat[][Deformed grid]{\includegraphics[width=0.48\textwidth]{mannheim_erection_2.jpg}\label{fig:erec_2}}
		%
		\vspace{10pt}
