...
\newcommand{\PlotStyleYLog}[6]{
	...
	xmin=#3 - (#4-#3) * \plotmargin,
	xmax=#4 + (#4-#3) * \plotmargin, 
%	restrict x to domain = #3 : #4, marche pas bien avec axis log. utiliser log10(#3):log10(#4) ?
	%
	ymin = 10^(log10(#5) - \plotmargin * \plotratio * (log10(#6) - log10(#5))),
	ymax = 10^(log10(#6) + \plotmargin * \plotratio * (log10(#6) - log10(#5))),
%	restrict y to domain = #5 : #6,
	%
	grid=major,
	grid style = { line cap = round, Tgray, line width = 0.25pt},
