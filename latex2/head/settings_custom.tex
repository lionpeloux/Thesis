...
%refsegment=chapter, 
%refsectio=chapter,
%defernumbers=true, % attention cette option semble faire buger l'ordre des citations dans la biblio
...
% source : https://tex.stackexchange.com/a/309995
\DeclareSourcemap{
    \maps{
...
% --  clear url field but for wepages
%\AtEveryBibitem{%
%  \ifentrytype{misc}{%
%  }{%
%    \clearfield{url}%
...
\renewcommand{\finentrypunct}{\addperiod~\icohref{}}
\newcommand{\icohref}{%
\ifboolexpr{%
	test {\ifhyperref}
	and
