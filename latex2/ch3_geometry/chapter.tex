...
\begin{figure}[!p]
	...
	\vspace{10mm}
	\input{ch3_geometry/plot/1_bench_kb/plot.tex}
...
%	\vspace{-5mm}
	...
	\vspace{10mm}
	\pgfplotstableread{ch3_geometry/plot/4_bench_semicircle/data.txt}\Table
	\subfloat[][$| 1-\frac{\mathcal{E}_1}{\mathcal{E}}(n) |$ in \%]{\input{ch3_geometry/plot/4_bench_semicircle/plot_vertex.tex}
		\label{plot:bench_semicircle_vertex}}\hspace{10mm}
	\subfloat[][$| 1-\frac{\mathcal{E}_3}{\mathcal{E}}(n) |$ in \%]{\input{ch3_geometry/plot/4_bench_semicircle/plot_edge.tex}
