...
% -------------------------------
\subsubsection{Vertex-based osculating circle (circumscribed)}
...
% mixed approach
% ---------------------
\subsubsection{Bitangent osculating circle (inscribed)}
...
\begin{equation}
\begin{aligned}
	\mathcal{E} &= \int_0^L \kappa^2 ds\\[10pt]
...
\begin{equation}
\begin{aligned}
	\mathcal{E} &= L \kappa^2 \\[10pt]
	\mathcal{E}_1 &= L_n  \kappa_1^2 = \frac{\sin (\varphi/2)}{\varphi/2} \cdot \mathcal{E}  \\[10pt]
...
\begin{figure}[!p]
	...
	\centering
%	\vspace{-5mm}
	\subfloat[][sequence of elastica curves]{\includegraphics{elastica_withnum.pdf}\label{fig:elastica_seq}}\\[5mm]
	\subfloat[][zoom on the discretization]{\includegraphics{elastica_detail.pdf}\label{fig:elastica_discretization}}
	\vspace{12pt}
...
%	\includegraphics[]{kb_edge_tangent.pdf}
%	\caption{Tangent vector at vertices.}
