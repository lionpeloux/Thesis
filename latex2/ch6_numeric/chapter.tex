...
Here, we use the fictitious kinetic damping proposed by Cundall in 1976. Th
...
The idea behind the dynamic relaxation algorithm is to find a state of static equilibrium of a given mechanical system. THis 

with an explicit scheme (central difference time integrator)



giving its rest stress, cross-section properties, material properties and initial geometric configuration.
