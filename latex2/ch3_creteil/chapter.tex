...
\blankpage{%
	...
	\AddToShipoutPictureBG*{% 
		...
		\PhotoCaptionRef[
			...
			yshift=\PhotoRefSkip,
			phantom=true,
			]{figure}{}{Exterior view of the gridshell}{fig:gs_ext}
		\intersectnode{CAtl |- Abr}{Pt}
		\PhotoTextBox[
			node=CAbl,
			anchor=base west,
			border=false,
				...
				\figurecaption{fig:gs_ext}\par\medskip
				The connections mark the fabric suggesting the interior grid structure. This texture enriches the perception of the building viewed from the outside and creates effects with the light reflections.
			}
	}
	\doubleblankpage[l]{%
		...
		\AddToShipoutPictureBG*{
			\PhotoCaptionRef[
				...
				yshift=-\PhotoRefSkip,
				phantom=true,
			]{figure}{}{Interior view of the gridshell}{fig:gs_int}}
	}{%
		\hbox{}\thispagestyle{empty}
		\AddToShipoutPictureBG*{
		\PhotoTextBox[
			...
			border=false,
				...
				\figurecaption{fig:gs_int}\par\medskip
				The grid pattern highlights the lightness of the structure and gives its tempo to the internal space. Lines converge to the altar, the heart of the liturgical area where the mass is offered on.
			}
	}}
}
...
\AddToShipoutPictureBG*{% 
	...
	\PhotoTextBox[
		...
		width=4cm-\PhotoSkip,
			...
			\figurecaption{fig:door}\par\medskip
			Two steel doors allow the entrance inside the building.\par\medskip
...
\afterpage{
	...
	\AddToShipoutPictureBG*{%
		...
		\PhotoCaptionRef[
			...
			anchor=south west, 
			yshift=\PhotoRefSkip,
		]{subfigure}{}{Begining of the deformation}{fig:erec_2a}
		\PhotoCaptionRef[
			hrefnode=BBtl,
			node=BBtl, 
			anchor=south west, 
			yshift=\PhotoRefSkip,
			]{subfigure}{}{Grid largely deformed}{fig:erec_2b}
		...
		\PhotoCaptionRef[
			...
			anchor=south west, 
			yshift=\PhotoRefSkip,
			]{subfigure}{}{Fixing the grid}{fig:erec_2c}
		\PhotoTextBox[
			node=BCbr,
			anchor=base west,
			xshift=\PhotoBigSkip,
	...
	\blankpage{%
		...
		\AddToShipoutPictureBG*{% 
			...
			\PhotoCaptionRef[
				...
				yshift=\PhotoRefSkip,
				phantom=true,
				]{figure}{}{Bracing of the grid}{fig:erec_3}
			\PhotoCaptionRef[
				hrefnode=DAtl,
				node=DAtl, 
				anchor=south west, 
				yshift=\PhotoRefSkip,
			]{subfigure}{}{Before triangulation}{fig:erec_3a}
			\PhotoCaptionRef[
				hrefnode=DBtl,
				node=DBtl, 
				anchor=south west, 
				yshift=\PhotoRefSkip,
				]{subfigure}{}{After triangulation}{fig:erec_3b}
			%%%
			...
			\PhotoCaptionRef[
				...
				yshift=\PhotoRefSkip,
				phantom=true,
				]{figure}{}{Installation of the membrane}{fig:erec_4}
			\PhotoCaptionRef[
				hrefnode=Pt,
				node=Pt, 
				anchor=south west, 
				yshift=\PhotoRefSkip,
			]{subfigure}{}{Unpacking the membrane}{fig:erec_4a}
			\PhotoCaptionRef[
				hrefnode=EBtl,
				node=EBtl, 
				anchor=south west, 
				yshift=\PhotoRefSkip,
				]{subfigure}{}{Pulling the membrane in the grid}{fig:erec_4b}
			\PhotoCaptionRef[
				hrefnode=ECtl,
				node=ECtl, 
				anchor=south west, 
				yshift=\PhotoRefSkip,
				]{subfigure}{}{The membrane is in place}{fig:erec_4c}
			\PhotoTextBox[
				node=AAtr,
				anchor=north west,
				xshift=\PhotoBigSkip,
...
\blankpage{%
	...
	\PhotoCaptionRef[
		...
		yshift=-\PhotoRefSkip,
		phantom=true,
		]{figure}{Flexural test of the GFRP tubes}{Flexural test of the GFRP tubes (Results from \cite{Tayeb2015a})}{plot:gfrp_tubes}
	\PhotoTextBox[
		node=CAbl,
		anchor=base west,
		width=10cm,
...
\doubleblankpage[l]{%
	...
	\AddToShipoutPictureBG*{%
		...
		\PhotoCaptionRef[
			...
			% yshift=-\PhotoRefSkip,
			phantom=true,
			]{table}{}{Cost details for masonry works}{tab:masonry}
		\PhotoTextBox[
			node=CAbl,
			anchor=base west,
			width=0.6\textwidth,
			border=false,
				...
				Prices are given excluding taxes (V.A.T). Only costs associated to the structure are reported here ; for instance the works for the equipment slab and the pathways are omitted. See \cref{fig:masonry} for a graphical representation of these data.
			}
	}
}{%
	\hbox{}\thispagestyle{pageonly}
