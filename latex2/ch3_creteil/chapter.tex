	...
	\AddToShipoutPictureBG*{% 
		...
		\PhotoTextBox[
			...
			border=false,
				...
				% \par\medskip
				% \figurecaption[]{fig:sub}
				% \cref{fig:situation_map}
				% Situation map. The temporary gridshell (1) was built very close to the permanent cathedral (2). Remark that  the two buildings cover a quite similar projected area.
				% \parbox[b]{10cm}{\kant[1]}
			}
	}
}
...
\afterpage{%
	...
	\settoheight{\tmpheight}{\includegraphics[height=5cm]{form}}
	\setlength{\tmpheight}{\tmpheight+\PhotoBigSkip}
