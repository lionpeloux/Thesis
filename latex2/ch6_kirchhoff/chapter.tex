...
\citef{Lang2009} claim that Lagrangian field theory leads to a more straightforward development of the work of Simo \cite{Simo1991} which is directly formulated using quaternions. This could be of practical interest when considering its implementation in a numerical solver.

\citef{Cisternas2002} extend Dill and Coleman extensible rod model to take into account thermal expansion. \citef{Moulton2013} offer an interesting treatment of extensible rods to model the growth of plants, whereas all the other papers cited here usually try to built their model upon the assumption that the rod is inextensible.

\citef{Lazaro2016} present a review of geometrically exact models for very flexible rods with the prospect of modeling bending active structures.
...
This paragraph gives a very brief overview of the \emph{special Cosserat theory of rods}, as presented by~\citef{Antman2005}, that accounts for bending, torsion, extension and shear  behaviors of slender beams.\footnote{\blockcquote[p.~270]{Antman2005}{[we formulate] a general dynamical theory of rods that can undergo large deformations in space by suffering flexure, torsion, extension, and shear. We call the resulting geometrically exact theory the \emph{special Cosserat theory of rods}.}} This theory -- which is a \emph{director theory} of rods -- was first introduced by~\citef{Antman1974}. It gives a larger scope to the basements of the present work -- which relies on the \emph{Kirchhoff theory of rods} -- as the last is a special case of this larger theoretical framework. Thus, what is presented in this paragraph could be considered as a reasonable starting point to extend the present work, for instance to take account for shear deformations or large extensions, which might be relevant for some engineering problems or form-finding processes.
...
\blankpage{
	...
	\AddToShipoutPictureBG*{% 
		...
		\PhotoCaptionRef[
			...
			yshift=\PhotoRefSkip,
			phantom=true,
			]{figure}{}{Description of the motion for a Cosserat rod~: longitudinal section}{fig:cosserat_1}
		\PhotoTextBox[
			node=CAb,
			anchor=base,
			width=\textwidth,
...
\blankpage{
	...
	\AddToShipoutPictureBG*{% 
		\Photo[
			...
			anchor=south east,
			xshift=-1cm,
			yshift=1.215cm + 0.5cm,
			]{cosserat_motion_trans_def_a.pdf}%
		\savenodes{A}
		\Photo[
			node=CAc,
			anchor=south west,
			xshift=1cm,
			yshift=1.215cm + 0.5cm,
			]{cosserat_motion_trans_def_b.pdf}%
		\savenodes{B}
		...
		\Photo[
			...
			anchor=north east,
			xshift=-1cm,
			yshift=-0.775cm + 0.5cm,
			]{cosserat_motion_trans_ref_a.pdf}%
		\savenodes{C}
		\Photo[
			node=CAc,
			anchor=north west,
			xshift=1cm,
			yshift=-0.775cm + 0.5cm,
			]{cosserat_motion_trans_ref_b.pdf}%
		\savenodes{D}
		%%
		\PhotoCaptionRef[
			hrefnode=Atl,
			...
			yshift=\PhotoRefSkip,
			phantom=true,
			]{figure}{}{Description of the motion for a Cosserat rod~: transverse section}{fig:cosserat_2}
		\PhotoCaptionRef[
			hrefnode=Atl,
			node=Atr,
			anchor=north east,
			]{subfigure}{}{Deformed cross-section $\mathcal{S}(s)$}{fig:cosserat_2a}
		\PhotoCaptionRef[
			hrefnode=Btl,
			node=Btr,
			anchor=north east,
			]{subfigure}{}{Deformed cross-section $\mathcal{S}(s+ds)$}{fig:cosserat_2b}
		\PhotoCaptionRef[
			hrefnode=Ctl,
			node=Ctr,
			anchor=north east,
			]{subfigure}{}{Reference cross-section $\rconf{\mathcal{S}}(s)$}{fig:cosserat_2c}
		\PhotoCaptionRef[
			hrefnode=Dtl,
			node=Dtr,
			anchor=north east,
			]{subfigure}{}{Reference cross-section $\rconf{\mathcal{S}}(s+ds)$}{fig:cosserat_2d}
		\PhotoTextBox[
			node=CAb,
			anchor=base,
			width=\textwidth,
	...
	\AddToShipoutPictureBG*{%
		\SBox[%
			...
			anchor=north,
				...
				\end{tabularx}}
		\savenodes{A}
		\intersectnode{Abr -| CAtl}{Pt}
		\PhotoCaptionRef[
			node=TL, 
			anchor=north west, 
			% yshift=-\PhotoRefSkip,
			phantom=true,
			]{table}{}{Summary of the notations employed throughout this section}{tab:secnotation}
		\PhotoTextBox[
			node=Abl,
			anchor=north west,
			yshift=-\PhotoRefSkip,
...
\afterpage{%
	\AddToShipoutPictureBG*{% 
		...
		\PhotoCaptionRef[
			...
			yshift=\PhotoRefSkip,
			phantom=true,
			]{figure}{}{Equilibrium of an infinitesimal slice of rod}{fig:rodslice}
		...
		\PhotoTextBox[
			...
			border=false,
				...
				\figurecaption{fig:rodslice}\par\medskip
				Internal forces ($\vect{F}$) and moments ($\vect{M}$) acting on an infinitesimal beam slice of length $ds$. The beam is also subject to distributed external forces ($\vect{f}$) and moments ($\vect{m}$). By convention, internal forces and moments are forces and moments applied by the right part to the left part of the beam.
			}
	}
	\setlength{\tmpheight}{11cm}
...
\rightblankpage{%
	...
	\AddToShipoutPictureBG*{% 
		\Photo[
			node=CAc,
			anchor=center,
			]{kirchhoff_cross_section_deformation.pdf}%
		\savenodes{A}
		%%
		\PhotoCaptionRef[
			hrefnode=Atl,
			...
			yshift=\PhotoRefSkip,
			phantom=true,
			]{figure}{}{Typical deformation modes of cross-sections in Kirchhoff's theory}{fig:section_defo}
		\PhotoTextBox[
			node=CAbl,
			anchor=base west,
			width=0.6\textwidth,
			border=false,
				...
				\figurecaption{fig:section_defo}\par\medskip
				Flexion around $\vect{d}_1$ (resp. $\vect{d}_2$) is measured through the material curvature $\varkappa_1$ (resp. $\varkappa_2$) ; torsion around $\vect{d}_3$ is measured through the material twist $\varkappa_3$ ; and $\epsilon$ measures the axial extension. Remark that cross-sections are subjected to both in-plane deformations ($\varkappa_1$, $\varkappa_2$, $\epsilon$) and out-of-plane deformations ($\varkappa_3$).
			}
	}
}
...
\doubleblankpage[r]{%
	...
	\AddToShipoutPictureBG*{% 
		...
		\PhotoCaptionRef[
			...
			yshift=\PhotoRefSkip,
			phantom=true,
			]{figure}{}{Geometric interpretation of Kirchhoff's equations}{fig:slice}
		\PhotoTextBox[
			node=CAbl,
			anchor=base west,
			width=0.6\textwidth,
	...
	\AddToShipoutPictureBG*{% 
		...
		\Photo[
			...
			anchor=north west,
			yshift=-\PhotoBigSkip,
			]{kirchhoff_balance_T_kb.pdf}%
		\savenodes{B}
		\intersectnode{CAtr |- Abr}{Pt}
		\Photo[
			node=Pt,
			anchor=north east,
			xshift=2mm,
			yshift=-\PhotoBigSkip,
			]{kirchhoff_balance_M_kb.pdf}%
		\savenodes{C}
		%%
		\PhotoCaptionRef[
			hrefnode=Atl,
			...
			yshift=\PhotoRefSkip,
			phantom=true,
			]{figure}{}{Geometric interpretation~: influence of the curvature ($\kappa$)}{fig:kb}
		\PhotoCaptionRef[
			hrefnode=Atl,
			node=Abl,
			anchor=north west,
			xshift=2mm,
			yshift=-\PhotoRefSkip,
			]{subfigure}{}{Infinitesimal deformation}{fig:kb_a}
		\PhotoCaptionRef[
			hrefnode=Btl,
			node=Bbl,
			anchor=north west,
			xshift=2mm,
			yshift=-\PhotoRefSkip,
			]{subfigure}{}{Contributions of the internal forces}{fig:kb_b}
		\PhotoCaptionRef[
			hrefnode=Ctl,
			node=Cbl,
			anchor=north west,
			xshift=2mm,
			yshift=-\PhotoRefSkip,
			]{subfigure}{}{Contributions of the internal moments}{fig:kb_c}
		\PhotoTextBox[
			node=CAbl,
			anchor=base west,
			width=0.6\textwidth,
			border=false,
				...
				\figurecaption{fig:kb}\par
				\figurecaption{fig:kb_a}\par
				\figurecaption{fig:kb_b}\par
				\figurecaption{fig:kb_c}
			}
		\intersectnode{CAtr |- Abl}{Pt}
		\PhotoTextBox[
			node=Pt,
			anchor=base east,
			yshift=2cm,
			...
			border=false,
				...
				Influence of the curvature ($\kappa$) in the deflection of internal forces and moments along the centerline. The osculating plane, perpendicular to $\vect{\kappa b}$, is represented in grey. $\vect{N}$ is the axial component of the internal force along $\vect{d}_3$. $\vect{Q}$ is the axial component of the internal moment, also known as the twisting moment along $\vect{d}_3$.
			}
	}
}
...
\blankpage{%
	...
	\AddToShipoutPictureBG*{% 
		...
		\PhotoCaptionRef[
			...
			yshift=\PhotoRefSkip,
			phantom=true,
			]{figure}{}{Geometric interpretation~: influence of the first material curvature ($\kappa_1$)}{fig:d1}
		\PhotoCaptionRef[
			hrefnode=Atl,
			node=Abl,
			anchor=north west,
			xshift=2mm,
			yshift=-\PhotoRefSkip,
			]{subfigure}{}{Infinitesimal deformation}{fig:d1_a}
		\PhotoCaptionRef[
			hrefnode=Btl,
			node=Bbl,
			anchor=north west,
			xshift=2mm,
			yshift=-\PhotoRefSkip,
			]{subfigure}{}{Contributions of the internal forces}{fig:d1_b}
		\PhotoCaptionRef[
			hrefnode=Ctl,
			node=Cbl,
			anchor=north west,
			xshift=2mm,
			yshift=-\PhotoRefSkip,
			]{subfigure}{}{Contributions of the internal moments}{fig:d1_c}
		\PhotoTextBox[
			node=CAbl,
			anchor=base west,
			width=\textwidth,
			border=false,
				...
				\figurecaption{fig:d1}\par
				\figurecaption{fig:d1_a}\par
				\figurecaption{fig:d1_b}\par
				\figurecaption{fig:d1_c}
			}
		\intersectnode{CAtr |- Abl}{Pt}
		\PhotoTextBox[
			node=Pt,
			...
			border=false,
				...
				Influence of the first material curvature ($\kappa_1$) in the deflection of internal forces and moments along the centerline. The plane perpendicular to $\vect{d}_1(s)$ is represented in grey. $\vect{F}_2$ is the transverse or shear component of the internal force along $\vect{d}_2$. $\vect{M}_2$ is the transverse or bending component of the internal moment along $\vect{d}_2$.
			}
	}
}

\clearpage
\subsection{influence of the first material curvature ($\kappa_1$)}
\subsubsection{Contributions to the balance of forces}
...
\blankpage{%
	...
	\AddToShipoutPictureBG*{% 
		...
		\PhotoCaptionRef[
			...
			yshift=\PhotoRefSkip,
			phantom=true,
			]{figure}{}{Geometric interpretation~: influence of the second material curvature ($\kappa_2$)}{fig:d2}
		\PhotoCaptionRef[
			hrefnode=Atl,
			node=Abl,
			anchor=north west,
			xshift=2mm,
			yshift=-\PhotoRefSkip,
			]{subfigure}{}{Infinitesimal deformation}{fig:d2_a}
		\PhotoCaptionRef[
			hrefnode=Btl,
			node=Bbl,
			anchor=north west,
			xshift=2mm,
			yshift=-\PhotoRefSkip,
			]{subfigure}{}{Contributions of the internal forces}{fig:d2_b}
		\PhotoCaptionRef[
			hrefnode=Ctl,
			node=Cbl,
			anchor=north west,
			xshift=2mm,
			yshift=-\PhotoRefSkip,
			]{subfigure}{}{Contributions of the internal moments}{fig:d2_c}
		\PhotoTextBox[
			node=CAbl,
			anchor=base west,
			width=\textwidth,
			border=false,
				...
				\figurecaption{fig:d2}\par
				\figurecaption{fig:d2_a}\par
				\figurecaption{fig:d2_b}\par
				\figurecaption{fig:d2_c}
			}
		\intersectnode{CAtr |- Abl}{Pt}
		\PhotoTextBox[
			node=Pt,
			...
			border=false,
				...
				Influence of the second material curvature ($\kappa_2$) in the deflection of internal forces and moments along the centerline. The plane perpendicular to $\vect{d}_2(s)$ is represented in grey. $\vect{F}_1$ is the transverse or shear component of the internal force along $\vect{d}_1$. $\vect{M}_1$ is the transverse or bending component of the internal moment along $\vect{d}_1$.
			}
	}
}

\clearpage
\subsection{Influence of the second material curvature ($\kappa_2$)}
\subsubsection{Contributions to the balance of forces}
