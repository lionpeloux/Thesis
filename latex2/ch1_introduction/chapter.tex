...
Dans \cref{chp:energy} nous élaborons un premier modèle de poutre à \dofs{4} par une approche variationnelle. Ici, nous reprenons et enrichissons un travail initié lors d'une précédente thèse inspiré par des travaux récents sur la simulation des tiges élastiques dans le domaine des \emph{computer graphics}, et à laquelle j'ai collaboré. En particulier, notre développement permet d'aboutir à des expressions purement locales des efforts internes et prouve l'équivalence avec le membre statique des équations de Kirchhoff. Sur le plan mathématique, le modèle est développé en continu et son implémentation numérique n'est pas traité.
...
%
% fondamentaux de description des courbes de l'espace. Nous 
%
%La relecture critique de cette expérience permet d'introduire 
% 
%définition précisons dans un premier temps  Le premier chapitre revient sur la définition  irconcis dresse un état des lieux précis des projets de gridshell réalisés jusqu'à aujourd'hui et des principales contributions académiques à travers une revue de la littérature.
%et des contributions théoriques (see \cref{chp:gridshell}). Le deuxième chapitre 
%
%
%
%
%
%autour de ces deux grands enjeux.

%
%Dans cette thèse je présente l'expérience personnelle que j'ai faite de ces structures et qui dépasse largement le temps académique consacré  
%
%
%à mi chemein entre la Les résultats que j'ai pu rassembler mais aussi les difficultées auxquelles j'ai été Cette expérience n'aura pas seulement été une aventure scientifique, mais bien plus une aventure tout court 
%
%Cette thèse relate mon expérience personnelle 
%a m'approprier le travail de mes prédéssessurs, à y porter un regard critique, à identifier les lacunes et à tenter d'y remedier par des développements théoriques et techniques originaux.
...
%
%
% \textquote{materiel} de conception disponible existant 
%
%Il s'agit de dépasser.
%
%
%Si l'équipe rassemblée 
%
%
%Intrication Architecte/.Ingénieur Justification vs. Conception. Agilité du processus de conception. Les outils de calcul actuels.
%
%
