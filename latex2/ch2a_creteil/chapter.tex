...
\centering
%\begin{fullpage}
	\pgfplotstableread{ch2a_creteil/plot/1_layer_benchmark/data.txt}\Table
	\input{ch2a_creteil/plot/1_layer_benchmark/plot.tex}
	\caption{Benchmark of different interface layers.}
	\label{fig:layer_benchmark}
%\end{fullpage}
\end{figure}
