...
\begin{figure}[p]
	...
	\begin{fullpage}	
		...
		%    
     		\vspace{1cm}
		%
		\subfloat[][Scaffold swivel coupler.]{\includegraphics[width=0.48\textwidth]{swivel.jpg}\label{fig:swivel}}
		\hspace*{\fill}
		\subfloat[][Steel sleeve.]{\includegraphics[width=0.48\textwidth]{sleeve.jpg}\label{fig:sleeve}} \\
		%
		\subfloat[][Ground anchorage.]{\includegraphics[width=0.48\textwidth]{anchorage.jpg}\label{fig:anchorage}}
		\hspace*{\fill}
		\subfloat[][Edge beam.]{\includegraphics[width=0.48\textwidth]{edge.jpg}\label{fig:edge}} \\
		%
		\vspace{10pt}
...
The overall cost of the project is \$500.000, approximately 30\% more than the rental for a standard tent of the same size for over 2 years.
The overall cost for the client is estimated to € 350.000 (excluding V.A.T). Puis on donne la ventilation générale.
It includes design stages, production works and fittings such as the heating system and the electrical network. It does not include the man-hours of the volunteers. The real cost of the design and production studies was higher and was considered as an investment buy the design company T/E/S/S.
\begin{figure}[h]
\begin{fullpage}
\centering
	\includegraphics[]{building}\vspace{10pt}
	\caption{Costs per square meter of covered area. Prices are given excluding taxes (V.A.T is 20~\%).}
	\label{fig:building}
	%
	\vspace{2cm}
	%
	\includegraphics[]{budget}\vspace{10pt}
	\caption{Project's budget. This is the estimated overall cost for the client. Prices are given excluding taxes (V.A.T is 20~\%).}
	\label{fig:budget}
\end{fullpage}
\end{figure}

\subsection{Detailed cost of the building}
...
\begin{figure}[p]
	...
	\begin{fullpage}	
		%
		\subfloat[][Paris 2016.]{\includegraphics[width=0.48\textwidth]{clc2016}\label{fig:clc}}
		\hspace*{\fill}
		\subfloat[][Montpellier 2016.]{\includegraphics[width=0.48\textwidth]{montpellier2016.jpg}\label{fig:montpellier}} \\
		%
		\vspace{10pt}
		\caption{Wooden gridshell built during the one-week workshop \textquote{Building Free Forms} at the Ecole des Ponts ParisTech.}
		\label{fig:parts}     
     		\vspace{1cm}
		%
		\subfloat[][Toulouse 2016.]{\includegraphics[width=0.48\textwidth]{toulouse2016}\label{fig:toulouse}}
		\hspace*{\fill}
		\subfloat[][Montpellier 2016.]{\includegraphics[width=0.48\textwidth]{montpellier2016.jpg}\label{fig:montpellier}} \\
		%
		\vspace{10pt}
		\caption{Modular wooden gridshells.}
		\label{fig:parts}    
	\end{fullpage}
\end{figure}
...
\begin{leftfullpage}
	...
	\caption{Volunteers man-hours spent on the gridshell fabrication. A 15\% increase is considered to take into account coordination and supervision of the individual tasks. See \cref{tab:manhours} for detailed data.}
	\label{fig:manhours}
\end{leftfullpage}
\end{figure}
\begin{table}[h]
...
%	\bottomrule
 	\end{tabularx}
	\vspace{10pt}
	\caption{Volunteers man-hours spent on the gridshell fabrication. A 15\% increase is considered to take into account coordination and supervision of the individual tasks. See \cref{fig:manhours} for a graphical representation of these data.}
	\label{tab:manhours}
\end{fullpage}
\end{table}
...
%	\bottomrule
 	\end{tabularx}
	\vspace{10pt}
	\caption{Cost details for masonry works. Prices are given excluding taxes (V.A.T is 20~\%). Only costs associated to the structure are reported here (for instance the works for the equipment slab and the pathways are omitted).}
\end{fullpage}
\end{table}
...
%	\bottomrule
 	\end{tabularx}
	\vspace{10pt}
	\caption{Cost details for superstructure elements. Prices are given excluding transport costs and excluding taxes (V.A.T is 20~\%). Only costs associated to the superstructure are reported here. Spare quantities are included.}
\end{fullpage}
\end{table}
...
For five tests, the factor $k_{n,5\%}$ is 1.80 , assuming a normal distribution. One can note that the connections scatter the results more (Table 1). Finally, the manufacturer value of 400MPa (ASTM D790) was confirmed and retained for further calculations.
\begin{table}[h]
\centering
