...
%\begin{subequations}
%	\begin{alignat}{1}
%	\frac{\partial^2 \varphi_s}{\partial {X_1}^2} + \frac{\partial^2 \varphi_s}{\partial {X_2}^2} &= 0
%	\\[0.5em]
%	n_1\left(\frac{\partial \varphi_s}{\partial {X_1}} - X_2 \right) + n_2\left(\frac{\partial \varphi_s}{\partial {X_2}} + X_1 \right) &= 0
%	\quad\quad \forall (X_1,X_2) \in \mathcal{S}(s), \; f(X_1,X_2)=0
%	\end{alignat}
%\end{subequations}
