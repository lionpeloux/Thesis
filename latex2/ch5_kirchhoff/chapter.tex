...
\begin{subequations}
	\begin{alignat}{1}
	\vect{N}_{2i+1/2} &= N_{2i+1/2}\, \vect{u}_{2i} \quad \text{where} \quad {N_{i+1/2}} = ES_i \,\epsilon_{2i+1/2}
	\\
	\vect{N}_{2i+3/2} &= N_{2i+3/2}\, \vect{u}_{2i+1}\quad \text{where} \quad {N_{i+3/2}} = ES_i \,\epsilon_{2i+3/2}
	\end{alignat}
\end{subequations}
...
\begin{subequations}
	...
	\end{alignat}
\end{subequations}
Remark that the derivative of the internal moments at mid edge is evaluated by the finite difference of the moment between the two closest vertices. This is in accordance with the quadratic interpolation method of a vector-valued function given in \cref{sec:appendix}. 
