...
The discrete beam element presented in \cref{chp:numerical_model} will directly results from the discretization of the dynamical Kirchhoff equations presented here, combined with an appropriate use of the the discrete curve-angle representation (see \cref{sec:crvangle}) and the discrete inscribed curvature (see \cref{sec:inscribe_dc}).
...
\item We retrieve the equations of motion of a Kirchhoff rod with a careful treatment of the assumptions, following \cite{Dill1992}. This allow us to established a framework
...
\citef{Simo1991} dans l'extension de \citef{Reissner1973}
...
Note that the boundary condition given by \cref{eq:warpingCL} stipulates that cross-sections are free to warp.
