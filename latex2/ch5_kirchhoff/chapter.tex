...
With some scaling arguments \cite{Dill1992} shows that terms in $w_1$ and $w_2$ should be negligible in the inertial forces of the rod given in \cref{eq:angularinertia}, which yields to :
\begin{subequations}
	\begin{alignat}{1}
...
\begin{subequations}
	\begin{alignat}{1}
	F'_1 + \omega_2 F_3 - \omega_3 F_2 + f_1 &= \rho S \ddot{x}_1
	\\
	F'_2 + \omega_3 F_1 - \omega_1 F_3 + f_2 &= \rho S \ddot{x}_2
	\\
	F'_3 + \omega_1 F_2 - \omega_2 F_1 + f_3 &= \rho S \ddot{x}_3
	\\
	M'_1 + \omega_2 M_3 - \omega_3 M_2 - (1+\epsilon)F_2  + m_1 & \simeq 0
	\\
	M'_2 + \omega_3 M_1 - \omega_1 M_3 + (1+\epsilon)F_1 + m_2 & \simeq 0
	\\
	M'_3 + \omega_1 M_2 - \omega_2 M_1 + m_3 & \simeq \rho (I_1 + I_2)\dot{w}_3
	\end{alignat}
\end{subequations}
