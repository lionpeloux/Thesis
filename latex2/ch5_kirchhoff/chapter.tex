...
%     	\centering
%     	\subfloat[][Infinitesimal deformation.]{\includegraphics{kirchhoff_geometry_kb.pdf}\label{<figure1>}} \\
%	\subfloat[][Contribution of the internal force.]{\includegraphics{kirchhoff_balance_T_kb.pdf}\label{<figure1>}}
%	\subfloat[][Contribution of the internal moment.]{\includegraphics{kirchhoff_balance_M_kb.pdf}\label{<figure2>}}
%	\vspace{10pt}
...
%	\captionsetup[subfloat]{captionskip=10pt}
%     	\centering
%     	\subfloat[][Infinitesimal deformation.]{\includegraphics{kirchhoff_geometry_d1.pdf}\label{<figure1>}} \\
%	\subfloat[][Contribution of the internal force.]{\includegraphics{kirchhoff_balance_T_d1.pdf}\label{<figure1>}}
%	\subfloat[][Contribution of the internal moment.]{\includegraphics{kirchhoff_balance_M_d1.pdf}\label{<figure2>}}
%	\vspace{10pt}
...
%	\captionsetup[subfloat]{captionskip=10pt}
%     	\centering
%     	\subfloat[][Infinitesimal deformation.]{\includegraphics{kirchhoff_geometry_d2.pdf}\label{<figure1>}} \\
%	\subfloat[][Contribution of the internal force.]{\includegraphics{kirchhoff_balance_T_d2.pdf}\label{<figure1>}}
%	\subfloat[][Contribution of the internal moment.]{\includegraphics{kirchhoff_balance_M_d2.pdf}\label{<figure2>}}
%	\vspace{10pt}
