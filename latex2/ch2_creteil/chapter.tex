...
\centering
\begin{fullpage}
	\includegraphics[]{ch2_creteil/plot/4_gfrp_tube/build.pdf}
...
\begin{figure}[!b]
	\centering
	\begin{fullpage}
	\includegraphics[width=\textwidth]{anchorage.pdf}
...
\begin{figure}[p]
	%
     	\centering
	\begin{leftfullpage}	
		\subfloat[][Temperature.]{\includegraphics[]{ch2_creteil/plot/5_thermal/build_Text.pdf}\label{plot:T_1}} \\
		\subfloat[][Solar radiation.]{\includegraphics[]{ch2_creteil/plot/5_thermal/build_Rad.pdf}\label{plot:T_2}} \\
		\vspace{10pt}
...
\begin{figure}[p]
	%
     	\centering
	\begin{fullpage}	
		\subfloat[][Without ventilation.]{\includegraphics[]{ch2_creteil/plot/5_thermal/build_Tint_noV.pdf}\label{plot:T_3}} \\
		\subfloat[][With ventilation.]{\includegraphics[]{ch2_creteil/plot/5_thermal/build_Tint_V.pdf}\label{plot:T_4}} \\
		\vspace{10pt}
